...
Every published entry is a bilingual case study with a problem, role, at least
two engineering decisions, a result, a non-empty stack, and at least one live
or source-code evidence URL. Historical entries may remain as drafts and are
not returned by the public portfolio endpoint.
